...
<head>
    ...
    <link rel="stylesheet"href="csslogin/dktk.css">
    <!-- Bootstrap CSS -->
...
<div class="container">
    <div class="body_content">
        <form action="signup" method="post" class="form my-form" id="form-1">
            <div >
            ...
            <div class="form-row">
                ...
                <div>
                    <input type="text" class="form-control" id="hoten" placeholder="Nhập họ tên" name="name">
            ...
            <div class="form-row">
                ...
                <div>
                    <input type="text" class="form-control" id="dangnhap" placeholder="Nhập tên đăng nhập" name="username" >
                    <small class="error"></small>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row" >
                ...
                <input type="date" class="form-control" id="ngaysinh" placeholder=""name="birthday">
            </div>

            <div class="form-row">
                <label for="SDT" >Số điện thoại</label>
                <div>
                    <input type="text" class="form-control" id="SDT" placeholder="Nhập số điện thoại" name="phonenmuber">
                    <small class="error"></small>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div>
                    <input type="text" class="form-control" id="CMND" placeholder="Nhập chứng minh nhân dân"name="cmnd">
                    <small class="error"></small>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div>
                    <input type="text" class="form-control" id="diachi" placeholder="Nhập địa chỉ" name="address">
                    <small class="error"></small>
                </div>
            </div>
            <div class="form-row">
                ...
                <div>
                    <input type="password" class="form-control" id="matkhau" placeholder="Nhập mật khẩu" name="password">
                    <small class="error"></small>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <span class="count" id="maxacminh" style="border-radius: 5px;margin-bottom: 10px;width: 100px;font-size: 25px"></span>
            ...
            <div class="form-row">
                ...
                <div>
                <input type="text" class="form-control" id="maxacminh1" placeholder="Nhập lại mã xác nhận">
                <small class="error"></small>
                </div>
            </div>
            <div class="form-row">
