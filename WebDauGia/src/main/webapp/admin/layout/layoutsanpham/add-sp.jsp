            ...
            <div class="col-sm-8">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3" style="align-items: center;display: flex;">
                        ...
                        <a class="ml-3">
                            <svg class="svg-inline--fa fa-arrow-rotate-left" aria-hidden="true" focusable="false"
                                 data-prefix="fas" data-icon="arrow-rotate-left" role="img"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control col-sm-10" id="ttnguoidang" name="ttnguoidang" rows="5"
                                  readonly></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control col-sm-10" id="buocgia" name="buocgia"
                               placeholder="Là giá thấp nhất cho mỗi lần tăng giá">
                        <small class="error"></small>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control col-sm-10" id="soluong" name="soluong"
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" type="text" name="thongtinchitiet" id="thongtinchitiet"
                                  rows="5"></textarea>
                        <small class="error"></small>
                    </div>
                </div>
