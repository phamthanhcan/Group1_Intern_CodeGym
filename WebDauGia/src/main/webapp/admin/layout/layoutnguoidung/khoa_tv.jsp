...
<div style="background-color: #73cbff7a">
    <form action="" method="post" class="form"id="form-1">
        ...
        <div class="row">
            ...
            <div class="row mb-3">
                <label for="thoigianbatdau" class="col-sm-4 col-form-label"
                       style="font-style: oblique; font-weight: bolder; color:black">Từ</label>
                <div class="col-sm-5">
            ...
            <div class="row mb-3">
                <label for="thoigianketthuc" class="col-sm-4 col-form-label"
                       style="font-style: oblique; font-weight: bolder; color: black ">Đến</label>
                <div class="col-sm-5">
        ...
        <div class="row mb-3">
            <div class="col-sm-4 " style="color: black;font-style: oblique; font-weight: bolder">
                <div> BẠN CÓ THỰC SỰ MUỐN KHÓA *</div>
            </div>
            <div class="col-sm-5 ">
